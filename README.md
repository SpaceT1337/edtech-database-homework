...
Логическая модель спроектирована с учетом нормализации данных и связей типа *One-to-Many* (1:M). Визуализация структуры базы данных с использованием нотации «вороньей лапки»:
